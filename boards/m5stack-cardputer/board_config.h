 ...
 * In Phase 4 it will be generated by: duneos-bspgen boards/m5stack-cardputer.yaml
 *
 * Hardware: ESP32-S3FN8, 8MB Flash (octal), 8MB QSPI PSRAM
 * Schematic reference: https://github.com/m5stack/M5Cardputer/tree/main/hardware
 *
 * WARNING: SD card SPI pins (MOSI/MISO/CLK/CS) should be verified against

/*
 * 8x8 pixel bitmap font — ASCII 32 (space) through 127 (DEL placeholder).
 * font8x8_basic[c - 32][row], row 0 = top.
 * Bit 0 of each byte = leftmost pixel of that row (LSB-left convention).
 * Render: pixel(col) = (font8x8_basic[c-32][row] >> col) & 1
 *
 * Derived from dhepper/font8x8 (MIT license, public domain subset of glyphs).
 */

...
def _stage(staging_dir: Path, board_name: str, safe_mode: bool = False) -> int:
    ...
    # Always stage the safe-mode init.yaml as `/flash/init.yaml.safe` so the
    # Phase 24.7 hold-key recovery path has something to load. Not used at
    # boot unless the board's recovery_pin is held.

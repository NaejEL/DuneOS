...
- **Architecture Decision Records** — [`docs/adr/`](docs/adr/) (15 ADRs as of 2026-05). Start at [`docs/adr/README.md`](docs/adr/README.md). Authoritative for design intent.

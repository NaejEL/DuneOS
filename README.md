...
| 24.8 — `<duneos/board.h>` auto-generated by dbt (kills hardcoded device paths) | 🟡 MVP (libdisp migrated) |
| 24.9 — Kernel driver self-registration (ELF section, no more vfs_dev.c hardcoding) | pending |
| 24.9.5 — Captured-app exit semantics (`duneos_exit` longjmps, doesn't kill shell) | pending |
| 24.10 — libgfx streaming mode (no userspace back-buffer; saves 64 KiB per gfx app) | pending |
